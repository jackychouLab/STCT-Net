...
if __name__ == "__main__":
    ...
    code_root = '/home/jackychou/Zhou/dataset/STCT-Net'
    chirp_nums = [32]
    use_filters = [11]
    sensor_type = "uniform"
    # use_filters = [1132]
        ...
        for use_filter in use_filters:
            for rangeDownSample in rangeDownSamples:
                ...
                if 'pca' in sensor_type:
                    sensor_config_path = os.path.join(code_root, f'configs/dataset_configs/pca_{chirp_num}.json')
                else:
                    sensor_config_path = os.path.join(code_root, f'configs/dataset_configs/{sensor_type}_{chirp_num}.json')
