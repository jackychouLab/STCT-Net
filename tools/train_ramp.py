    ...
    def train(self, ):
        for epoch in range(self.n_epoch):
            ...
            for iter, data_dict in enumerate(self.train_dataloader):
                ...
                confmap_preds, confmap_preds2 = self.model(data_ra, data_rv, data_va)
                loss_confmap = 0
                if self.stacked_num is not None:
                    ...
                    loss_base_1 = self.criterion(confmap_preds, confmap_gt)
                    loss_base_2 = self.criterion_2(confmap_preds, confmap_gt)
                    loss_exo = self.criterion(confmap_preds2, confmap_gt)
