...
class RadarStackedHourglass(nn.Module):
    ...
    def __init__(self, n_class, stacked_num=1):
        ...
        self.conv1a = nn.Conv3d(in_channels=2, out_channels=32, dilation=(1, 1, 1),
...
class RODNet_DCSN(nn.Module):
    def __init__(self, n_class, stacked_num=1):
        super(RODNet_DCSN, self).__init__()
